<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"/Users/lijiafei/Documents/project/fanli1/public/../application/admin/view/member/users.html";i:1523426012;}*/ ?>
...
<script>
	...
	function setDivData(data){
	    str = '';
	    str += '<table class="table table-striped"  style="font-size:14px;margin-top: 20px;"><th>user_id</th><th>昵称</th><th>余额</th><th>积分</th><th>父级id</th><th>级别</th><th>等级</th><th>业绩</th><th>创建时间</th>';
