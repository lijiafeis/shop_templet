<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/Users/lijiafei/Documents/project/fanli1/public/../application/admin/view/main/index.html";i:1523676553;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<div class="well">
	...
	<div class="col-sm-3">
		<div class="view" style="background:#428bca">
			<div class="inner">
				<em class="number" id="setwithdrow">#</em><div class="title">等待打款总额</div>
			</div>
		</div>
	</div>
	<div class="col-sm-3">
		<div class="view" style="background:#428bca">
			<div class="inner">
				<em class="number" id="withdrowId">#</em><div class="title">等待打款id</div>
			</div>
		</div>
	</div>
</div>
	...
	function setData3(){
		$.ajax({
			...
			success:function (data) {
				...
				$("#setwithdrow").text(data.setwithdrow)
				$("#withdrowId").text(data.withdrowId)
			}
		});
	}
