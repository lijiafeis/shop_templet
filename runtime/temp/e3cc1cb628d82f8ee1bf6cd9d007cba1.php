<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"/Users/lijiafei/Documents/project/fanli1/public/../application/admin/view/config/config.html";i:1523512457;}*/ ?>
	...
	<div class="main-content">
	  ...
	  <div class="tab-content well" style="margin-top:30px;border:1px solid #dddddd;padding:10px 2%;">
		...
		<div class="form-group">
			...
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 col-lg-1 control-label">VIP比例</label>
				<div class="col-sm-6 col-lg-4">
					<input type="text" class="form-control"  name="vip_bili" value="<?php echo $info['vip_bili']; ?>" placeholder="">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 col-lg-1 control-label">省代比例</label>
				<div class="col-sm-6 col-lg-4">
					<input type="text" class="form-control"  name="sd_bili" value="<?php echo $info['sd_bili']; ?>" placeholder="">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 col-lg-1 control-label">总代比例</label>
				<div class="col-sm-6 col-lg-4">
					<input type="text" class="form-control"  name="zd_bili" value="<?php echo $info['zd_bili']; ?>" placeholder="">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 col-lg-1 control-label">官方比例</label>
				<div class="col-sm-6 col-lg-4">
					<input type="text" class="form-control"  name="gf1_bili" value="<?php echo $info['gf1_bili']; ?>" placeholder="">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 col-lg-1 control-label">联创比例</label>
				<div class="col-sm-6 col-lg-4">
					<input type="text" class="form-control"  name="lc_bili" value="<?php echo $info['lc_bili']; ?>" placeholder="">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 col-lg-1 control-label">同级招比例</label>
				<div class="col-sm-6 col-lg-4">
					<input type="text" class="form-control"  name="tj_bili" value="<?php echo $info['tj_bili']; ?>" placeholder="">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 col-lg-1 control-label">下级招比例</label>
				<div class="col-sm-6 col-lg-4">
					<input type="text" class="form-control"  name="xj_bili" value="<?php echo $info['xj_bili']; ?>" placeholder="">
				</div>
			</div>
