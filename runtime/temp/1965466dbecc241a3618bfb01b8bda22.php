<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/Users/lijiafei/Documents/fanli/fanli/public/../application/admin/view/shop/shop.html";i:1522371842;}*/ ?>
<head>
	<meta charset="UTF-8">
...
<script>
	...
	function setDivData(data){
	    var str = '';
	    //0 表示可以操作  1 表示不可以操作
		str += '<table class="table table-striped"  style="font-size:14px;margin-top: 20px;"><th>序号</th><th>商品名称</th><th>价格</th><th>分类名字</th><th>库存</th><th>销量</th><th>是否199元商品</th><th>是否秒杀</th><th>是否推荐</th><th>操作</th>';
