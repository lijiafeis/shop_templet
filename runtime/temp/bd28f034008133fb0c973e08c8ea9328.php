<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"/Users/lijiafei/Documents/project/fanli1/public/../application/admin/view/jifen/jifen.html";i:1522286340;}*/ ?>
<head>
	<meta charset="UTF-8">
		...
		<div class="main-content">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<div style="margin-bottom:20px;"><a href="<?php echo url('add_jifen'); ?>"><button type="button" class="btn btn-default" style="background:#44b549;color:#fff;margin-top: 10px;">新增积分</button></a></div>
...
<script>
	function editShop(id){
		if(id == ''){
		    ...
		    location.href = "<?php echo url('edit_jifen'); ?>?id=" + id;
		}
	}
