<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/Users/lijiafei/Documents/project/fanli1/public/../application/admin/view/img/index.html";i:1522286340;}*/ ?>
<!DOCTYPE html>
...
<head>
	...
	<script src="/static/admin/laypage/laypage.js"></script>
	<script src="/static/admin/js/xigua.upload.js"></script>
...
<script>
var xigua = {
		pic_address:"uploads/shop/",//图片文件夹地址
		nums:8,   //每页显示数
		a_url:"<?php echo url('pic_data'); ?>", //请求地址
		pageid:'page4',//页码显示id
...
$(document).ready(function(){
	...
	//监听上传文件变更
		...
		$.ajaxFileUpload({
			url: "<?php echo url('pic_upload'); ?>", //用于文件上传的服务器端请求地址
